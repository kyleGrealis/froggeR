...
```{r, echo=FALSE, fig.align='center', fig.cap='How froggeR manages settings across projects (config.yml)', out.width='70%'}
knitr::include_graphics("../man/figures/config-file.png")
```
