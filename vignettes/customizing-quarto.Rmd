...
```{r, echo=FALSE, fig.align='center', fig.cap='Code block styling - Before', out.width='70%'}
...
```{r, echo=FALSE, fig.align='center', fig.cap='Code block styling - After', out.width='70%'}
