...
> Leaving values blank will not cause errors, but modify these values carefully.
...
[IMAGE: man/figures/settings_flow.png]
*How froggeR manages settings across projects*
...
Before:
[IMAGE: man/figures/code_block_before.png]
...
After:
[IMAGE: man/figures/code_block_after.png]
