...
```{r, echo=FALSE, eval=FALSE, fig.align='center', fig.cap='How froggeR manages settings across projects'}
...
```{r, echo=FALSE, eval=FALSE, fig.align='center', fig.cap='Code block styling - Before'}
knitr::include_graphics("man/figures/code_block_before.png")
```
...
// $code-block-bg: darken($body-bg, 3%);
```
...
```{r, echo=FALSE, eval=FALSE, fig.align='center', fig.cap='Code block styling - After'}
knitr::include_graphics("man/figures/code_block_after.png")
```
...
$link-color: $primary;    // Links match primary
```
