...
```{r, echo=FALSE, eval=FALSE, fig.align='center', fig.cap='Project directory structure example'}
...
```{r, echo=FALSE, eval=FALSE, fig.align='center', fig.cap='Integrated YAML structure example'}
...
```{r, echo=FALSE, eval=FALSE, fig.align='center', fig.cap='Comparison of document types'}
