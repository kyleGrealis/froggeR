...
[IMAGE: man/figures/project_structure.png]
...
2. **Project Settings** (`_variables.yml`)
   ...
   ```
   > These values come from your `froggeR_settings()`
...
[IMAGE: man/figures/project_yaml.png]
*Example of the integrated YAML structure*
...
[IMAGE: man/figures/document_types.png]
...
1. **Initial Setup**
  ...
  Recommended additional project structure:
...
> When working in a `froggeR` project, `write_quarto()` automatically uses your project's `_variables.yml` settings by default, ensuring consistent styling and metadata across all documents.
