...
That's it. froggeR creates the complete project structure and opens it in a new RStudio session.
...
A new RStudio session opens with the complete project ready to go.
...
7. **Open in new session**: Launch RStudio with the new project

All functions are called with `.initialize_proj = TRUE` to prevent auto-opening files, since they're in a new project location.
