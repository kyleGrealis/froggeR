...
`init()` downloads the latest template from [frogger-templates](https://github.com/kyleGrealis/frogger-templates) and populates the directory with the full scaffold. If you have previously saved global config with `save_variables()` or `save_brand()`, your metadata and branding are already in place.
